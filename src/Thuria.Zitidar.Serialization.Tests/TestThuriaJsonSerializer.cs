...
//        Assert.AreEqual(this.serializedJsonData, jsonString);
//      }
//
//      [Test]
...
//        //---------------Assert Precondition----------------
//        //---------------Execute Test ----------------------
//        var serializationClass = jsonSerializer.DeserializeObject<FakeSerializationClass>(this.serializedJsonData, true);
//        //---------------Test Result -----------------------
...
//        //---------------Assert Precondition----------------
//        //---------------Execute Test ----------------------
//        var serializationClass = jsonSerializer.DeserializeObject(this.serializedJsonData, true) as FakeSerializationClass;
//        //---------------Test Result -----------------------
//        Assert.IsNotNull(serializationClass);
//        Assert.IsInstanceOf<FakeSerializationClass>(serializationClass);
//        Assert.AreEqual(new Guid("e4df5e95-c956-409c-b9f1-a0a5a8505303"), serializationClass.Id);
...
//        {
//          FinalPrice = new decimal[] { 1.0m, 1.0m, 1.0m }
//        };
//        var jsonSerializer = new ThuriaJsonSerializer(new ThuriaDefaultJsonSerializerSettings());
//        //---------------Assert Precondition----------------
//        //---------------Execute Test ----------------------
...
//        Assert.That(jsonData, Is.EqualTo(SerializationTestData.CoreSerializedJsonData));
//      }
//
//      [Test]
...
//        var fakeTestData = new FakeTestData
//        {
//          FinalPrice = new decimal[] { 1.0m, 2.0m, 3.12345m }
//        };
//        var jsonSerializer = new ThuriaJsonSerializer(new ThuriaDefaultJsonSerializerSettings());
//        var jsonData = jsonSerializer.SerializeObject(fakeTestData);
//        Console.WriteLine(jsonData);
...
//      {
//        //---------------Set up test pack-------------------
//        var jsonData = SerializationTestData.CoreSerializedJsonData;
//        var jsonSerializer = new ThuriaJsonSerializer(new ThuriaDefaultJsonSerializerSettings());
